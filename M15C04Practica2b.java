...
public class M15C04Practica2b extends Mouse {
    
    private HashMap<Pair<Integer, Integer>, Nodo> laberinto;
    private HashMap<Pair<Integer, Integer>, Nodo> nodosCalculados;
    ...
    private void algoritmoAEstrella(Nodo NodoPrincipal, Pair<Integer, Integer> queso) {
        ...
        while (contadorOpciones < 4) {
            ...
            if (!nodosCalculados.containsKey(casillaMejorOpcion) && laberinto.containsKey(casillaMejorOpcion)) {
    ...
    private HashMap<Pair<Integer, Integer>, Nodo> getPadre(Nodo nodoPrincipal, Pair<Integer, Integer> queso, List<Nodo> noExploradas) {
        ...
        nodosCalculados.put(nodoPrincipal.getPosicion(), nodoPrincipal);
            ...
            if (celda.down) {
                ...
                if (laberinto.containsKey(posicionObjetivo)) {
                    ...
                    if (!visitados.contains(celdaAux)) {
                        ...
                        nodosCalculados.put(celdaAux.getPosicion(), celdaAux);
    ...
    public M15C04Practica2b() {
        super("CakeAE");
        camino = new Stack();
        laberinto = new HashMap();
        nodosCalculados = new HashMap();
    ...
    public int move(Grid currentGrid, Cheese cheese) {
        ...
        /*Llamamos a la función M15C04Practica2b*/
        if (camino.isEmpty()) {
            if (nodosCalculados.isEmpty()) {
